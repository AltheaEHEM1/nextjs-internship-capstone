...
export function useProjectBoard() {
    ...
    const setActiveColumn = useProjectBoardStore((state) => state.setActiveColumn);
    ...
    const setIsViewTaskOpen = useProjectBoardStore((state) => state.setIsViewTaskOpen);
    const selectedTask = useProjectBoardStore((state) => state.selectedTask);
    const setSelectedTask = useProjectBoardStore((state) => state.setSelectedTask);
