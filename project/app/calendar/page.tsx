			...
			<div className="rounded-lg border border-french_gray-300 bg-white p-6 dark:border-payne's_gray-400 dark:bg-outer_space-500">
				<div className="mb-6 flex items-center justify-between">
					<div className="flex items-center space-x-4">
						<button
							type="button"
							className="rounded-lg p-2 hover:bg-platinum-500 dark:hover:bg-payne's_gray-400"
						>
							<ChevronLeft size={20} />
						</button>
					...
					<div className="flex space-x-2">
						<button
							type="button"
							className="rounded bg-blue_munsell-100 px-3 py-1 text-sm text-blue_munsell-700 dark:bg-blue_munsell-900 dark:text-blue_munsell-300"
						>
							Month
						</button>
						<button
							type="button"
							className="rounded px-3 py-1 text-sm text-payne's_gray-500 hover:bg-platinum-500 dark:text-french_gray-400 dark:hover:bg-payne's_gray-400"
						>
							Week
						</button>
						<button
