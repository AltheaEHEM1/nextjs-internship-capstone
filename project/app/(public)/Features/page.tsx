...
import { CheckCircle2, Clock, ShieldCheck, Sparkles, Layers, ListTodo, Zap, Activity, ArrowUpRight,} from "lucide-react";
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 sm:mb-16 gap-6">
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-900/80 border border-slate-800 backdrop-blur-md self-start md:self-auto">
                        ...
                        <span className="text-xs font-medium text-slate-300">
                            System Health: <strong className="text-emerald-400 font-bold">99.99%</strong>
                        </span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-6">
                    ...
                    <div className="lg:col-span-8 bg-slate-900/50 border border-slate-800 hover:border-indigo-500/50 transition-all rounded-3xl p-5 sm:p-8 flex flex-col justify-between backdrop-blur-md relative overflow-hidden group">
                        ...
                        <div>
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">Core Workflow Engine</h3>
                            ...
                            <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8 max-w-md">
                                <div className="bg-slate-950/60 border border-slate-800 p-3 sm:p-4 rounded-xl">
                                    <span className="text-xs text-slate-500 block">Data Latency</span>
                                    <span className="text-lg sm:text-xl font-bold text-white">&lt; 45ms</span>
                                </div>
                                <div className="bg-slate-950/60 border border-slate-800 p-3 sm:p-4 rounded-xl">
                                    <span className="text-xs text-slate-500 block">State Sync</span>
                                    <span className="text-lg sm:text-xl font-bold text-white">Realtime</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-4 bg-slate-900/50 border border-slate-800 hover:border-amber-500/50 transition-all rounded-3xl p-5 sm:p-8 flex flex-col justify-between backdrop-blur-md">
                        <div>
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Team & Workspace Controls</h3>
                    ...
                    <div className="lg:col-span-6 bg-slate-900/50 border border-slate-800 hover:border-emerald-500/50 transition-all rounded-3xl p-5 sm:p-8 backdrop-blur-md">
                        <div className="flex items-center justify-between mb-6 gap-2">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-xs text-emerald-400 font-bold block">Module 03</span>
                                    <h3 className="text-base sm:text-lg font-bold text-white">UX Layer</h3>
                                </div>
                            </div>
                            <span className="text-xs text-slate-400 font-mono shrink-0">FCP Speed: 0.2s</span>
                        </div>
                    ...
                    <div className="lg:col-span-6 bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-all rounded-3xl p-5 sm:p-8 backdrop-blur-md">
                        <div className="flex items-center justify-between mb-6 gap-2">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-xs text-slate-400 font-bold block">Module 04</span>
                                    <h3 className="text-base sm:text-lg font-bold text-white">Advanced Engine Roadmap</h3>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-400">
                            ...
                            <div className="flex items-center gap-2">
                                <Clock className="w-3.5 h-3.5 shrink-0" /> Optimistic UI rendering
                            </div>
                            <div className="flex items-center gap-2">
