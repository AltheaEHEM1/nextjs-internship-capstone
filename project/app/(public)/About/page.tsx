                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                                        <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center transition-colors shrink-0 ${
                                            isActive ? item.accentBg : "bg-slate-100 text-slate-500 group-hover:bg-slate-200"
                                        }`}>
                                    ...
                                    <ChevronRight className={`w-4 h-4 transition-all shrink-0 ${
                                        isActive ? "text-slate-800 translate-x-1" : "text-slate-400 opacity-0 group-hover:opacity-100"
                                    }`} />
                                </button>
                            );
                        })}
                                    ...
                                    {features.map((_, idx) => (
                                        <div
                                            ...
                                            className={`h-1.5 rounded-full cursor-pointer transition-all duration-500 ${
                                                idx === activeTab ? `w-8 bg-gradient-to-r ${activeFeature.gradient}` : "w-3 bg-slate-200 hover:bg-slate-300"
                                            }`}
                                        />
                                    ))}
                                </div>
