		...
		tasks: [
			{
				...
				description:
					"Create a modern, responsive landing page with hero section, features grid, and CTA.",
				status: "To Do",
				assignee: "CR",
				priority: "high",
				dueDate: "2026-08-15",
			...
			},
			{
				...
				description:
					"Implement login, register, and forgot password pages with form validation.",
				status: "To Do",
				assignee: "AS",
				priority: "high",
				dueDate: "2026-08-12",
			...
			},
			{
				...
				description:
					"Sidebar overlay does not dismiss on outside tap in mobile viewports.",
				status: "To Do",
				assignee: "MC",
				priority: "medium",
				dueDate: "2026-08-10",
			...
			},
			{
				...
				description:
					"Wire up dnd-kit for drag-and-drop between board columns with smooth animations.",
				status: "In Progress",
				assignee: "AS",
				priority: "high",
				dueDate: "2026-08-09",
			...
			},
			{
				...
				description:
					"Create real-time notification bell with unread count badge and dropdown list.",
				status: "In Progress",
				assignee: "MC",
				priority: "medium",
				dueDate: "2026-08-11",
			...
			},
			{
				...
				description:
					"Set up GitHub Actions for automated testing, linting, and deployment to staging.",
				status: "In Progress",
				assignee: "DC",
				priority: "medium",
				dueDate: "2026-08-08",
			...
			},
			{
				...
				description:
					"Build team listing page with member cards, invite modal, and role badges.",
				status: "Done",
				assignee: "CR",
				priority: "high",
				dueDate: "2026-08-05",
			...
			},
			{
				...
				description:
					"Create Zustand stores for project, team, and board state management.",
				status: "Done",
				assignee: "AS",
				priority: "medium",
				dueDate: "2026-08-03",
			...
			},
			{
				...
				description:
					"Dark mode resets to light on page refresh — store preference in localStorage.",
				status: "Done",
				assignee: "JR",
				priority: "low",
				dueDate: "2026-08-02",
