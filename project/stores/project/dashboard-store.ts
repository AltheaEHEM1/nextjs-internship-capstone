...
import { BarChart3, CheckCircle, Clock, TrendingUp, Users, type LucideIcon } from 'lucide-react';
...
export const useDashboardStore = create<DashboardState>()(
  devtools((set, get) => ({
    ...
    recentProjects: [
      { id: 1, name: "Project 1", lastUpdated: "Last updated 2 hours ago", progressPercent: 66 },
      { id: 2, name: "Project 2", lastUpdated: "Last updated 2 hours ago", progressPercent: 66 },
      { id: 3, name: "Project 3", lastUpdated: "Last updated 2 hours ago", progressPercent: 66 },
    ],
    quickActions: [
    ...
    upcomingDeadlines: [
      { title: "Website Redesign", date: "Dec 15, 2026", type: "Project Deadline" },
