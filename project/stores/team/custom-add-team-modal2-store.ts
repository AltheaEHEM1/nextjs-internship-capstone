// stores/custom-add-team-modal2-store.ts
"use client";
...
export interface CustomAddTeamModal2State {
  // data
...
export const useCustomAddTeamModal2Store = create<CustomAddTeamModal2State>()(
  devtools((set, get) => ({
    membersList: [],
    currentMember: "",
    currentRole: "Member",
